...
var buildContactSensor = function buildContactSensor(Base) {
    var ContactSensor = function (_Base) {
        _inherits(ContactSensor, _Base);
...
exports.default = buildContactSensor;