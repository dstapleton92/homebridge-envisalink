...
var EnvisalinkAccessoryClassBuilder = function EnvisalinkAccessoryClassBuilder(Service, Characteristic, Accessory, uuid) {
    var EnvisalinkAccessory = function (_Accessory) {
        ...
        function EnvisalinkAccessory(log, accessoryType, config, partition, zone) {
            ...
            } else if (_this.accessoryType == "motion") {
                var _service = new Service.MotionSensor(_this.name);
                _service.getCharacteristic(Characteristic.MotionDetected).on('get', _this.getMotionStatus.bind(_this));
                _this.services.push(_service);
            } else if (_this.accessoryType == "door") {
                var _service2 = new Service.ContactSensor(_this.name);
                _service2.getCharacteristic(Characteristic.ContactSensorState).on('get', _this.getContactSensorState.bind(_this));
                _this.services.push(_service2);
            } else if (_this.accessoryType == "window") {
                var _service3 = new Service.ContactSensor(_this.name);
                _service3.getCharacteristic(Characteristic.ContactSensorState).on('get', _this.getContactSensorState.bind(_this));
                _this.services.push(_service3);
            } else if (_this.accessoryType == "leak") {
                var _service4 = new Service.LeakSensor(_this.name);
                _service4.getCharacteristic(Characteristic.LeakDetected).on('get', _this.getLeakStatus.bind(_this));
                _this.services.push(_service4);
            } else if (_this.accessoryType == "smoke") {
                var _service5 = new Service.SmokeSensor(_this.name);
                _service5.getCharacteristic(Characteristic.SmokeDetected).on('get', _this.getSmokeStatus.bind(_this));
                _this.services.push(_service5);
            }
            return _this;
        }
...
exports.default = EnvisalinkAccessoryClassBuilder;